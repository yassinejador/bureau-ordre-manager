...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: (
          <HiOutlineUsers className="w-5 h-5 text-white-700" />
        ),
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { label: "Ajouter une Permission", route: "/forms/form-ajouter-permission"},
      ...
      {
        icon: (
          <RiBuilding2Line className="w-5 h-5 text-white-700" /> 
        ),
      ...
      {
        icon: (
          <FaHistory className="w-5 h-5 text-white-700" />
        ),
        label: "Historique",
        route: "/logs",
      },
