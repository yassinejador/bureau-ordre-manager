...
interface SidebarProps {
  ...
  roleId: string; // Ajout du rôle en tant que prop
}
  ...
  const menuGroups = [
    {
      ...
      menuItems: [
        ...
        roleId === "1"
          ? {
              icon: <HiOutlineUsers className="text-white-700 h-5 w-5" />,
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      route: "/forms/form-ajouter-permission",
                    },
                    {
        ...
        roleId === "1" || roleId === "2"
          ? {
              icon: <RiBuilding2Line className="text-white-700 h-5 w-5" />,
        ...
        roleId === "1"
          ? {
              icon: <FaHistory className="text-white-700 h-5 w-5" />,
              label: "Historique",
              route: "/logs",
            }
          : null,
