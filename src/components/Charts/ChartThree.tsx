...
const courriersEntrants = 120;
const courriersSortants = 80;
const totalCourriers = courriersEntrants + courriersSortants;

const percentEntrants = ((courriersEntrants / totalCourriers) * 100).toFixed(1);
const percentSortants = ((courriersSortants / totalCourriers) * 100).toFixed(1);
...
const ChartThree: React.FC = () => {
  ...
  return (
    <div className="col-span-12 rounded-lg border border-stroke bg-white p-6 shadow xl:col-span-4">
      <h5 className="text-lg font-semibold text-gray-800">Répartition des Courriers</h5>
