...
export const metadata: Metadata = {
  title: "Connexion | Bureau d'Ordre - FS El Jadida",
  description:
    "Page de connexion du système de gestion du bureau d'ordre de la Faculté des Sciences d'El Jadida",
};
      ...
      <div className="w-full max-w-[1400px] rounded-xl border border-stroke bg-white shadow-default">
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full lg:block lg:w-1/2">
            <div className="h-full px-8 py-12 lg:px-12 xl:px-16">
              <div className="mb-10 text-center">
                <h1 className="mb-4 text-2xl font-bold text-primary">
                  Bureau d'Ordre Digital
                </h1>
                <p className="text-gray-600 lg:px-8">
                  Système de gestion numérique du bureau d'ordre de la Faculté
                  des Sciences d'El Jadida
                </p>
              </div>
