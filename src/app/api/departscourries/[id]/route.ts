...
import { deleteCourrier, fetchCourriersAvecFichiersById } from '../../../../../lib/queries/départs'; // Adapter le chemin
...
export async function GET(req: Request, { params }: { params: { id: string } }) {
    try {
        ...
        // Retourne le courrier avec les détails, y compris 'traite_par'
