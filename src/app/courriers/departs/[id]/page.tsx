...
const TableFiches = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Détails courriers Départs" />
          ...
          <table className="w-full border-collapse border border-gray-300 dark:border-gray-700">
            <tbody>
              ...
              <tr className="border-b border-gray-300 dark:border-gray-700">
                ...
                <td className="px-4 py-3 text-gray-900 dark:text-white">{courrier.destination}</td>
              </tr>
              <tr className="border-b border-gray-300 dark:border-gray-700">
                <td className="px-4 py-3 font-medium text-gray-700 dark:text-gray-300">Traité par :</td>
                <td className="px-4 py-3 text-gray-900 dark:text-white">{courrier.traite_par}</td>
              </tr>
              <tr className="border-b border-gray-300 dark:border-gray-700">
